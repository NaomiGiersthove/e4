<?php 
    ...
    // Function reserveringen bewerken
    ...
    // Function melding voor no-show klanten
...
<?php include_once 'navigatie.php'; ?>
	...
	<table>
		...
		<tbody>
			...
			<h2>Reserveringen van vandaag: <?php echo $current_date ?></h2>
			...
			<?php foreach ($row_data AS $data) { ?>
				<form method="post">
					<tr>
						...
						<td><button type="submit" name="no_show" onclick="return confirm('Is deze klant niet komen opdagen?');">No Show</button></td>
...
<?php }else{
	echo "<h3>Er zijn geen reserveringen vandaag</h3>";
} ?>
	...
	<form method="post">
		...
		<button type="submit" name="add" onclick="return confirm('Deze reservering plaatsen?');">Toevoegen</button>
	</form>
</body>
</html>